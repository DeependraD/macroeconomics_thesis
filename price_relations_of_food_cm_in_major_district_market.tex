...
\begin{figure}
\includegraphics[width=0.95\linewidth]{price_relations_of_food_cm_in_major_district_market_files/figure-latex/study-districts-1} \caption{Geographical perspective on market selections for study}\label{fig:study-districts}
\end{figure}
...
\includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ar-process-1.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ar-process-2.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ar-process-3.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ar-process-4.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ar-process-5.pdf}

Why and AR(2) process is stationary

\includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ma-process-1.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ma-process-2.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ma-process-3.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ma-process-4.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ma-process-5.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ma-process-6.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ma-process-7.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ma-process-8.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ma-process-9.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/simulating-ma-process-10.pdf}
...
\includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/trend-fit-lprice-1.pdf}

Smoothed annual mean and standard deviation of retail price/lprice/diff\_lprice series in Kathmandu.

\includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/mean-and-sd-year-1.pdf} \includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/mean-and-sd-year-2.pdf}
...
\includegraphics{price_relations_of_food_cm_in_major_district_market_files/figure-latex/rice-wheat-historical-annual-series-1.pdf}
