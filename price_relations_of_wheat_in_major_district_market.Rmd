...
- These markets either have a large production volumes or strong consumer segment. Because districts of terai, and mostly those of Western to Farwestern region, show consistently high annual production volume (Terai is also dubbed grain basket of Nepal) major producer districts in terai -- Kailali, Kanchanpur, Kapilvastu, Rupandehi, Parsa and Bara are included in the study. At the same time Surkhet, Chitwan and Kathmandu districts have prominance of consumers.
- An equally important aspect of current study is aggregation of some of the district market series. To justify this, we present some of the unique features of selected districts.
  - Kailali and Kanchanpur are terai districts in farwestern region. They both lie bordering with India through Uttar Pradesh state. Both districts have huge chunks of land annually allocated to Wheat production (How much in total ???, what percentage of total wheat cultivated area ???). Both the districts are closely related socio-culturally, as the farmer segment comprises mainly of Tharu community.
  - Parsa and Bara are districts of central region. They border with India through Bihar state. Both districts cultivate Wheat in large volume (areawise how much ???). These two districts are likewise related socio-culturally, in terms of residence of Madhesi community. 
